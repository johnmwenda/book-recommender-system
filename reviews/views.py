...
def user_recommendation_list(request):
    ...
    # get reviews by those users, excluding wines reviewed by the request user_reviews
    other_users_reviews = Review.objects.filter(
        user_name__in=other_members_usernames).exclude(wine_id__in=user_reviews_wine_ids)
